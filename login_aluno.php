                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row" style="background-color: #f5e3c1;">
                            <div class="col-lg-6 d-none d-lg-block" style="padding-top: 192px; background-color: #e7d5b4; color: #660114;"><a class="sidebar-brand d-flex align-items-center justify-content-center" style="color:#660114;">
                            ...
                            <div class="col-lg-6">
                                <div class="p-4">
                                    <div class="text-center" >
                                        <h1 class="h4 mb-4" style="font-weight: 800; color: #660315;">Login do Aluno: </h1>
                                    </div>
                                    ...
                                    <form class="user" method="post" action="">
                                        ...
                                        <input type="submit" value="Entrar" class="btn btn-facebook btn-user btn-block ">
                                            <hr>
                                    </form>
                                    </div>
                                    <?php
