...
echo "<thead><tr><th>Disciplina</th><th>Nota</th></tr></thead>";
...
while ($row = $result->fetch_assoc()) {
    $disciplina = $row['nome'];
    if (isset($notas_por_disciplina[$disciplina]) && $notas_por_disciplina[$disciplina] !== null) {
        $nota = $notas_por_disciplina[$disciplina];
        echo "<tbody><tr><td>".$disciplina."</td><td>".$nota."</td></tr></tbody>";
    }
}
